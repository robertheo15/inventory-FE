    ...
    <div className="modal fade" id="modalItem" tabIndex="-1" aria-labelledby="modalItemLabel" aria-hidden="true">
        <div className="modal-dialog modal-xl">
            ...
            <div className="modal-body">
                ...
                <label htmlFor="inputTitle1" className="col-sm-2 col-form-label">Produk varian:</label>
                <div className="col-sm-10">
                    <input type="text" className="form-control" id="inputTitle1"/>
                </div>
                </div>
                <div className="mb-3 row">
                <label htmlFor="inputTitle2" className="col-sm-2 col-form-label">stok:</label>
                <div className="col-sm-10">
...
export default ModalChildProduct
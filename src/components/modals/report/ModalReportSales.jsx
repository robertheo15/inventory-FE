...
const ModalReportSales = ({ transactionCustomer }) => {
  ...
  return (
    <div
      ...
      id="modalReportSales"
      tabIndex="-1"
      aria-labelledby="modalReportSalesLabel"
      aria-hidden="true"
    >
      <div className="modal-dialog modal-xl">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="modalReportSalesLabel">
              Detail transaksi
            </h5>
            <button
              type="button"
          ...
          <div className="modal-body">
            ...
            >
              <table className="table table-bordered">
                ...
                <tbody>
                  {transactionCustomer != undefined && Object.keys(transactionCustomer).length > 0 ? (
                    transactionCustomer.map((detail, key) => {
...
export default ModalReportSales;

  ...
  <>
    <nav className="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
      <a className="navbar-brand me-lg-5" href="/">
        <img className="navbar-brand-dark" src="/img/brand/light.svg" alt="Coffee logo" /> <img className="navbar-brand-light" src="/img/brand/dark.svg" alt="Coffee logo" />
      </a>
          ...
          <ul className="nav flex-column pt-3 pt-md-0">
              <li className="nav-item">
                  <a href="/" className="nav-link d-flex align-items-center">
                      <span className="sidebar-icon">
                          <img src="/img/brand/light.svg" height="20" width="20" alt="Coffee Logo" />
                      </span>
              ...
              <li className="nav-item  active ">
                  <a href="/dashboard" className="nav-link">
                      ...
                      <span className="sidebar-text">Dasbor</span>
                  </a>
              </li>
              ...
              <li className="nav-item">
                  <span className="nav-link  collapsed  d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#reports">
                      <span>
                          <span className="sidebar-icon">
                              <ImBook/>
                          </span>
                  ...
                  <div className="multi-level collapse " role="list" id="reports" aria-expanded="false">
                    <ul className="flex-column nav">
                      <li className="nav-item ">
